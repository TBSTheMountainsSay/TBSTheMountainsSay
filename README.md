...
Resume: [HeadHunter](https://hh.ru/resume/28e56d45ff0c277c270039ed1f5a5337676859?disableBrowserCache=true&hhtmFrom=resume_list)
...
| [Volvo](https://github.com/TBSTheMountainsSay/Volvo) | Сайт-визитка для Volvo. Используется API (apilayer.com) для валидации номера телефона. Из фишек: добавлен таймер бездействия пользователя на второй странице; Переход с 1 страницы на 2-ую ставит видео на паузу. Переход обратно воспроизводит видео с момента паузы. Проект доступен для просмотра на [GH-Pages](https://tbsthemountainssay.github.io/Volvo/). | 
